            ...
            <div className=" text-white">
                ...
                <ul className="list-unstyled mt-3">
                    <li className=" texto-con-borde align-items-center mb-3">
                        ...
                        <a
                            href="https://wa.me/5491144798497"
                            target="_blank"
                    ...
                    <li className=" text-primary texto-con-borde align-items-center mb-3 ">
                        ...
                        <a className="  fw-bold" href="mailto:aesfronsecretaria@gmail.com">
                            aesfronsecretaria@gmail.com
                        </a>
                    </li>
                </ul>
            </div>
            <div className=" text-white ">
                ...
                <ul className="list-unstyled">
                    <li className="  texto-con-borde align-items-center mb-3">
                        ...
                        <a
                            href="https://www.facebook.com/profile.php?id=61558921479885"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <li className=" texto-con-borde align-items-center mb-3">
                        ...
                        <a className=" fw-bold" href="https://www.tiktok.com/@aesfron">
                            Ticktok
                        </a>
                    </li>
                    <li className=" texto-con-borde align-items-center mb-3">
                        <FaInstagram size={25} className="me-2 " style={{ color: "red" }} />
                        <a className=" fw-bold" href="https://www.instagram.com/aesfron/">
                            Instagram
                        </a>
                    </li>
                </ul>
