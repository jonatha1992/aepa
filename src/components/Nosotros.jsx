            ...
            <div className=" d-flex justify-content-between  mt-5 flex-wrap align-items-center align-content-center">
                <motion.div className=" mx-auto  col-12  col-lg-6  justify-content-center align-items-center ">
                    ...
                    <p className="parrafo-nosotros">
                        <span className="highlight">Nuestro Objetivo</span> es empoderar a los profesionales de la
                        salud, para brindar una atención de calidad, basada en evidencia científica.
                        <span className="highlight"> La Misión</span> consiste en empoderar a enfermeros y profesionales
                        para brindar atención de calidad, a través de la capacitación interprofesional fundamentada en
                        el respeto de la diversidad cultural. Perseguimos una <span className="highlight">Visión</span>{" "}
                        que consiste en convertirnos en líderes internacionales en la capacitación y fortalecimiento de
                        profesionales de la salud. Inspirándonos en{" "}
