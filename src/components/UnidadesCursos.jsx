  ...
  return (
    <div
      ...
      onMouseLeave={
        isClickable
          ? (e) =>
              (e.currentTarget.style.backgroundColor = itemStyle.background)
          : null
      }
    >
      <div className="d-flex flex-row align-items-center w-100">
        ...
        {item.tipo.toLowerCase() === "pdf" && (
          <DownloadForOfflineIcon style={{ marginLeft: "auto" }} />
        )}
      </div>
    </div>
  );
...
const UnidadAccordion = ({ unidad }) => (
  <Accordion key={unidad.id}>
    <AccordionSummary
      ...
      style={accordionItemSummaryStyle}
    >
      <FolderIcon
    ...
    <>
      <Accordion className="mb-3" defaultExpanded style={headerStyle}>
        ...
        >
          ...
          <label className="text-capitalize fw-bold fs-5 w-100 text-start mb-0   ">
            Información
          </label>
        </AccordionSummary>
