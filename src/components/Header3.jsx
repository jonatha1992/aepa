                ...
                <div className="login-icon">
                    {isAlumnosRoute && User ? (
                        <>
                            ...
                            <ExitToAppIcon sx={{ fontSize: "3rem", marginLeft: "10px", cursor: "pointer" }} onClick={handleLogout} />
                        </>
                    ) : (
                        <AccountCircleIcon sx={{ fontSize: "3rem" }} onClick={() => navigate("/alumnos")} />
                    )}
                </div>
            </div>
        </header>
