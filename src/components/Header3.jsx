            ...
            <nav className="navbarstyle">
                <ul className={isMobileMenuOpen ? "menu-open" : ""}>
                    <li onClick={closeMobileMenu}>
                        {/* hacer logica para dependiendo donde este valla a seccion
                        si es en landing si no que vaya a la pagina inicio */}
                    ...
                    <li onClick={closeMobileMenu}>
                        <a href="#seccion3">Anuncios y eventos</a>
                    </li>
                    <li onClick={closeMobileMenu}>
                        <a href="#seccion4">Cursos</a>
                    </li>
                    <li onClick={closeMobileMenu}>
                        <a href="#seccion5">Contacto</a>
                    </li>
                    <li onClick={closeMobileMenu}>
                        <a href="#seccion6">Login</a>
                    </li>
                </ul>
            </nav>
        </header>
