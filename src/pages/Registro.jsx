...
const defaultCountry = countries.find(country => country.codeValue === countryCode || country.nameValue === countryName) || countries[0];

const defaultCodigo = defaultCountry.codeLabel;
        ...
        <>
            <div className="container">
                <div className="row ">
                    ...
                    <div className="col-md-12 d-flex justify-content-center bg-danger-subtle p-3 rounded-5 ">
                        <Formik
                            initialValues={{
                                nombre_completo: "",
                                DNI: "",
                        ...
                        >
                            <Form
                                className="col-lg-9 col-sm-12 fs-6 text-black"
                                ref={formRef}
                            >
                                ...
                                <div className="form-floating mb-3">
                                    ...
                                    <label htmlFor="codigo_tel">Codigo Pais</label>
                                    <ErrorMessage
                                        name="codigo_tel"
                                        component={(props) => (
                                            <Error message={props.children} />
