      ...
      <nav className="navbarstyle">
        ...
        <ul className={isMenuOpen ? "menu-open" : ""}>
          <li onClick={closeMenu}>
            <Link to="/home">
              {" "}
              <h3 className="item-menu">Inicio</h3>
            </Link>
          </li>
          <li onClick={closeMenu}>
            <Link to="/nosotros">
              {" "}
              <h3 className="item-menu"> Nosotros</h3>
            </Link>
          </li>
          <li onClick={closeMenu}>
            <Link to="/cursos">
              <h3 className="item-menu"> Cursos</h3>
            </Link>
          </li>
          <li onClick={closeMenu}>
            <Link to="/talleres">
              <h3 className="item-menu"> Talleres</h3>
            </Link>
          </li>
          <li onClick={closeMenu}>
            <Link to="/socios">
              <h3 className="item-menu"> Socios</h3>
            </Link>
          </li>
        </ul>
